...
class Economy:
	...
	@commands.command(name='daily', description="Claims the daily reward", hidden=False)
	# [+] DAILY
	...
	@commands.command(name='wallet', description="Displays the User's or Target User's credits in the wallet", hidden=False)
	# [+] WALLET
