...
class Economy:
	...
	@commands.command(name='daily', description="Claims the daily reward", hidden=False, short_doc="Claims the daily reward")
	# [+] DAILY
	...
	@commands.command(name='wallet', description="Displays the User's or Target User's credits in the wallet", hidden=False, short_doc="Displays the User's or Target User's credits in the wallet")
	# [+] WALLET
